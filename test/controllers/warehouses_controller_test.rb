...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { address: @warehouse.address, deleted_at: @warehouse.deleted_at, greenhouses_id: @warehouse.greenhouses_id, name: @warehouse.name, tas_id: @warehouse.tas_id }
    end
  ...
  test "should update warehouse" do
    patch :update, id: @warehouse, warehouse: { address: @warehouse.address, deleted_at: @warehouse.deleted_at, greenhouses_id: @warehouse.greenhouses_id, name: @warehouse.name, tas_id: @warehouse.tas_id }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
