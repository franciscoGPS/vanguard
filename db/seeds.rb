...
User.create(name: "Admin", job: "Systems", encrypted_password: 'Agave15', email: 'hola@agaveti.com', admin: true)
User.create(name: "Vanguard", job: "Vanguard Admin", encrypted_password: 'Prueba123!', email: 'diana.s@vanguardco.com.mx', admin: true, role_id: 1)
